...
},{"./tabs":15}],4:[function(require,module,exports){
"use strict";

var _iosVhFix = require("./utils/ios-vh-fix");
var _form = require("./modules/form-validate/form");
var _video = require("./modules/form-validate/video");
...
},{"./init-accordion":2,"./init-tabs":3,"./modules/form-validate/form":6,"./modules/form-validate/video":12,"./modules/reviews-slider":13,"./modules/slider":14,"./utils/ios-vh-fix":17}],5:[function(require,module,exports){
"use strict";
...
function setupVideo(video) {
  ...
  var media = video.querySelector('picture');
  var button = video.querySelector('.about__video-button');
  var id = 'https://www.youtube.com/embed/9TZXsZItgdw?rel=0&showinfo=0&autoplay=1';
...
var reviewSlider = function reviewSlider() {
  reviewsSlider && new Swiper('.swiper2', {
    navigation: {
